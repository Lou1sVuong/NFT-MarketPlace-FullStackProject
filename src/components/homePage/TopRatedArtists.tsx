    ...
    return (
        <div className='py-20 px-40 text-textW'>
            <div className='relative flex mb-14' >
                <div>
                    <h2 className='text-[2.375rem] font-semibold'>Top creators</h2>
                    <p className='text-[1.375rem] font-normal '>Checkout Top Rated Creators on the NFT Marketplace</p>
                </div>
                <div className='absolute bottom-0 right-0'>
                    <Button style='nofillSecondary'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.82722 4.95319L5.83612 4.95312H10.883C11.2282 4.95312 11.508 5.23295 11.508 5.57812C11.508 5.9233 11.2282 6.20312 10.883 6.20312H5.84496L5.83991 6.20828L5.83988 6.20825L3.30957 8.73075L3.31054 8.73094L6.58398 9.38719C6.92242 9.45504 7.14178 9.78441 7.07393 10.1229C7.00608 10.4613 6.67671 10.6807 6.33827 10.6128L3.0658 9.95675C3.06562 9.95671 3.06543 9.95668 3.06524 9.95664C2.84349 9.91244 2.63788 9.80892 2.47031 9.65711C2.3026 9.50516 2.17928 9.31054 2.11351 9.094C2.04775 8.87746 2.042 8.64712 2.09689 8.42757C2.15178 8.20802 2.26525 8.00749 2.42518 7.84738L2.42612 7.84644L2.42612 7.84644L4.95522 5.32514C5.18573 5.09151 5.49894 4.95786 5.82722 4.95319Z" fill="#A259FF" />
                        </svg>
                        View Rankings
                    </Button>
                </div>
