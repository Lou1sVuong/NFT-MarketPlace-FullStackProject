    ...
    return (
        <div className="relative inline-block justify-center items-center py-3 px-5 w-full bg-textW rounded-[1.25rem]">
            <div className="flex justify-center items-center">
                ...
                <div className="w-full ml-12"><input type={inputType} className=" placeholder:text-bg focus:outline-none mr-4 w-[80%] text-bg  " placeholder={placeholder} /></div>
                {type === 'password' && (
                ...
                {rightIcon && <span className="absolute right-9 mr-4">{rightIcon}</span>}
            </div>
