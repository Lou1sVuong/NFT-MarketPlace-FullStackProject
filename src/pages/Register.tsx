        ...
        <div className='w-full h-[40rem] flex gap-[3.75rem] text-textW bg-bg'>
            ...
            <div className='flex flex-col justify-center items-center w-[50%]'>
                <div className='flex flex-col justify-center items-center gap-8 w-[80%]'>
                    ...
                    <p className='text-lg w-[25rem] text-center'>Welcome! enter your details and start creating, collecting and selling NFTs.</p>
                    ...
                    <div>
                    Already have an account? <Link to='/SignIn'><span className='text-callAcction'>Sign In</span></Link>
                    </div>
                </div>
