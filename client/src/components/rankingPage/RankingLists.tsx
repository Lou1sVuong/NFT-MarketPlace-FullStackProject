...
function RankingLists({ data }: RankingListsProps) {
  ...
  return (
    <div>
      <div className="flex justify-center items-center w-full text-xl text-textW mt-8">
        <div className="flex flex-col gap-5 w-full">
          {/* body */}
          <div className="flex w-full items-center text-nowrap text-left bg-bgsecondary rounded-[1.25rem] px-5 py-4">
            <div className="w-[10%]">
              <div className="inline-block  text-base text-captiontext  rounded-full bg-bg">
                <p className="flex text-center justify-center items-center h-8 w-8 ">
                  {rank}
                </p>
              </div>
            </div>
