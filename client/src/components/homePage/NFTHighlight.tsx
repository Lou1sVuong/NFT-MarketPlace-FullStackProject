import NFTHightlightBG from '../../assets/images/homePage/NFTHighlight/NFTHighlightBG.png';
import Button from '../common/Button';
import Countdown from './Countdown';
import tempAvatar from '../../assets/images/avatars/skaterRobot.svg';

function NFTHighlight() {
    return (
        <div className="relative w-full h-[40rem] text-textW ">
            <div className='absolute w-full h-full backdrop backdrop-blur-[1px] bg-gradient2 opacity-[0.3]'></div>
            <div className='absolute w-full h-full pt-[22rem] px-40 '>
                <div className='w-[10rem] flex gap-3 py-[0.6rem] px-[1.25rem] bg-bgsecondary  rounded-[1.5rem]'>
                    <img className='w-[1.5rem] h-[1.5rem] rounded-full' src={tempAvatar} alt="" />
                    <p>Shroomie</p>
                </div>
                <div className='relative flex justify-between'>
                    <div className='flex flex-col gap-[2rem]'>
                        <h2 className='text-[3.1875rem] font-semibold'>Magic Mashrooms</h2>
                    ...
                    <div className='absolute bottom-0 right-0'><Countdown hours={68.86} /></div>
                </div>
            </div>
